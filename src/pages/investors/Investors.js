  ...
  return (
      <div className="investors">
          ...
          <div className="investors_section">
            <h2 className='investors_header'>Letter to Shareholders</h2>
          ...
          <div className="investors_section">
            <h2 className='investors_header'>Business principles</h2>
          ...
          <div className="investors_section">
            <h2 className='investors_header'>Meeting our customer's needs</h2>
          ...
          <div className="investors_section last_section">
            <h2 className='investors_header'>Solutions for the energy transition</h2>
